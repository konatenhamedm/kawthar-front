...
<div class="w-full  mx-auto">
    ...
    <select id="{id}"     disabled={disabled} bind:value={selectedId} class="rounded-4 dark:bg-box-dark-up text-body dark:text-subtitle-dark focus:ring-primary focus:border-primary min-h-[50px] w-full border border-black px-[20px] py-[12px] text-[15px] outline-none placeholder:text-[#A0A0A0]">
